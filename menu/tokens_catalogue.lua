...
M.TOKENS = {
    ...
    { description = _("Time left in chapter (minutes only)"), token = "%chap_time_left_min", chip = "time" },
    { description = _("Time left in book (hours only)"), token = "%book_time_left_h", chip = "time" },
    { description = _("Time left in book (minutes only)"), token = "%book_time_left_min", chip = "time" },
